...
class MinitaurBulletEnv(gym.Env):
  ...
  def is_fallen(self):
    ...
    return (np.dot(np.asarray([0, 0, 1]), np.asarray(local_up)) < 0.75 or pos[2] < 0.10)
  ...
  def _reward(self):
    ...
    #   elif position[0]<0:
    #     forward_reward = current_base_position[0] - self._last_base_position[0]
    #   else: forward_reward=0
    # if forward_reward<0:
    #   if position[0]>=0:
    #     forward_reward = current_base_position[0] - self._last_base_position[0]
    #   elif position[0]<0:
    #     forward_reward = 1.3*(current_base_position[0] - self._last_base_position[0])
